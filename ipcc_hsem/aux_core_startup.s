...
aux_core_startup:
    ...
    // Set up stack. Force 16-byte alignment like the primary core does: AArch64
    // faults (EC 0x26, SP alignment) on the first push otherwise, and since the
    // vector table is already installed the handler inherits the bad SP and
    // faults again -- an endless ESR/ELR/FAR dump.
