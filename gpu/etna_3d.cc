...
//
//   texture cache flushes      etnaviv_emit.c:256-281
//                              descriptor flush: etnaviv_context.c:553-562
//
...
//
//   VS/PS counts/temps/regs    emit: etnaviv_emit.c:~394+
//                              values: etna_link_shaders() etnaviv_shader.c:~150-290
//                              VS input map: etnaviv_shader.c:~355-400
//
//   PA viewport                EMIT_STATE_FIXP etnaviv_emit.c:~405 (the FIXP
//                              macro IS the 0x04000000 header bit)
//                              values: etna_set_viewport_states() etnaviv_state.c:~495
//
//   SE scissor/clip            etnaviv_emit.c + etnaviv_state.c (margins)
//
//   PE color target/LOGIC_OP   etna_set_framebuffer_state() etnaviv_state.c:~180-400
//
//   depth config               fb half: etnaviv_state.c:322-392
//                              test/write half: etnaviv_zsa.c
//                              combine: etnaviv_state.c:~950-1000
//
...
//
//   NTE sampler + TXDESC       etna_emit_texture_desc() etnaviv_texture_desc.c:289-383
//                              sampler values: desc.c:88-128
//                              the 256-byte descriptor (fill_tex_descriptor): desc.c:134-240
//                              layout: mesa/src/etnaviv/hw/texdesc_3d.xml.h
//                              formats: etnaviv_format.c:161,331
//
