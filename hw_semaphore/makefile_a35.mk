# Builds the Cortex-A35 firmware: runs on both A35 cores (core 1 enters at
# aux_core_startup) and embeds the M33 firmware (firmware_m33.h, generated by
...
SOURCES += main_a35.cc
SOURCES += main_aux_a35.cc
SOURCES += $(SHAREDDIR)/drivers/psci.cc
